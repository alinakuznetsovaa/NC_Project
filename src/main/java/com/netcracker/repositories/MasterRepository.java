...
public interface MasterRepository extends JpaRepository<Master, Integer> {
    @Query(value = "SELECT record.record_id as recordId, client.first_name as firstName,client.last_name as lastName, client.email as address, \n" +
    ...
    List<RecordDtoForMaster> getRecordsOfMaster(Integer id);
